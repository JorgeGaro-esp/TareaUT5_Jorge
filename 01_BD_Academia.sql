...
CREATE TABLE profesores(
    ...
    CONSTRAINT FK_profesores_departamentos FOREIGN KEY (pedepar)
...
CREATE TABLE cursos(
    ...
    CONSTRAINT FK_cursos_profesores FOREIGN KEY (cprofe)
...
CREATE TABLE clases(
    ...
    CONSTRAINT FK_clases_cursos FOREIGN KEY (clcurso)
...
CREATE TABLE matriculas(
    ...
    CONSTRAINT FK_matriculas_estudiantes FOREIGN KEY (manues)
        REFERENCES estudiantes (esnume),
    CONSTRAINT FK_matriculas_cursos FOREIGN KEY (manucu)
        REFERENCES cursos (cnume)
);
