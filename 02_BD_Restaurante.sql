...
CREATE TABLE detalle_pedido(
    ...
    CONSTRAINT FK_Id_Pedido_Pedidos FOREIGN KEY (id_pedido)
        REFERENCES pedidos(id_pedido),
    CONSTRAINT FK_Id_Plato_Pedidos FOREIGN KEY (id_plato)
...
ALTER TABLE platos ADD CONSTRAINT CK_Precio_Plato
