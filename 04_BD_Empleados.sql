...
CREATE TABLE departamentos(
    ...
    CONSTRAINT FK_departamentos_dpto_padre FOREIGN KEY (dpto_padre)
...
CREATE TABLE estudios(
    ...
    CONSTRAINT FK_estudios_empleado_DNI FOREIGN KEY (empleado_DNI)
...
CREATE TABLE historial_laboral(
    ...
    CONSTRAINT FK_historial_laboral_empleado_DNI FOREIGN KEY (empleado_DNI)
        REFERENCES empleados (DNI),
    CONSTRAINT FK_historial_laboral_trabajo_cod FOREIGN KEY (trabajo_cod)
        REFERENCES trabajos(trabajo_cod),
    CONSTRAINT FK_historial_laboral_dpto_cod FOREIGN KEY (dpto_cod)
        REFERENCES departamentos (dpto_cod),
    CONSTRAINT FK_historial_laboral_supervisor_DNI FOREIGN KEY (supervisor_DNI)
        REFERENCES empleados (DNI)
);
