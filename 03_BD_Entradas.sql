...
CREATE TABLE espectaculos(
    ...
    CONSTRAINT FK_espectaculos_cod_recinto FOREIGN KEY (cod_recinto)
...
CREATE TABLE representaciones(
    ...
    CONSTRAINT FK_representaciones_cod_espectaculo FOREIGN KEY (cod_espectaculo)
...
CREATE TABLE precios_espectaculos(
    ...
    CONSTRAINT FK_precios_espectaculos_cod_espectaculo FOREIGN KEY (cod_espectaculo)
        REFERENCES espectaculos (cod_espectaculo),
    CONSTRAINT FK_precios_espectaculos_zonas_recintos FOREIGN KEY (cod_recinto, zona)
...
CREATE TABLE asientos(
    ...
    CONSTRAINT FK_asientos FOREIGN KEY (cod_recinto, zona)
        REFERENCES zonas_recintos(cod_recinto, zona)
);
...
CREATE TABLE entradas(
    ...
    CONSTRAINT FK_entradas_espectadores FOREIGN KEY (dni_cliente)
        REFERENCES espectadores(dni_cliente),
    CONSTRAINT FK_entradas_representaciones FOREIGN KEY (cod_espectaculo, fecha, hora)
